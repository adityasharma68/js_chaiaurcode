...
const map = new Map();
map.set("IN", "India"); // in map we write in first braclet is key and second work as a value
map.set("USA", "United States of America");
map.set("FR", "France");
map.set("IN", "India"); // in the map there is unique value if we write in the map and give double entry so it takes only one entry.
